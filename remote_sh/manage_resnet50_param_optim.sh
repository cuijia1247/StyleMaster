...
# ResNet50 超参数网格搜索进程管理脚本
# Author: cuijia1247
# Date: 2026-03-29
# 用法：从项目根目录执行 ./remote_sh/manage_resnet50_param_optim.sh {start|stop|status|tail|tail-current|result|logs}

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")/.." && pwd)"
cd "$SCRIPT_DIR"

PID_FILE="resnet50_param_optim.pid"
RESULT_DIR="param_optim/resnet50"
