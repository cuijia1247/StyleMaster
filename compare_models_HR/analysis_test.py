    ...
    with open(file_path, 'r') as f:
        for line in f:
            ...
            if len(parts) < 2:
                ...
                continue
            try:
                true_label = int(parts[1].split(": ")[1])
                if len(parts) >= 3:
                    pred_label = int(parts[2].split(": ")[1])
                else:
...
# 加载数据
true_labels, pred_labels = read_results("/home/huangrui/Codes/SubStyleClassfication/compare_models/classify_result/new15-densenet121-wikiart3-classification.txt")

# 准确率
accuracy = accuracy_score(true_labels, pred_labels)
print('====================densenet121-wikiart3======================')
...
plt.title("densenet121-wikiart3-Confusion Matrix")
plt.savefig("/home/huangrui/Codes/SubStyleClassfication/compare_models/analysis_matrix_pic/densenet121-wikiart3-confusion_matrix.png", dpi=300, bbox_inches="tight")
plt.show()
...
df.to_csv("/home/huangrui/Codes/SubStyleClassfication/compare_models/analysis_csv/wikiart3-densenet121-per_class_misclassification.csv", index=False)
...
fig.update_layout(title_text="densenet121-wikiart3-Misclassification Flow - Sankey Diagram", font_size=12)
fig.show()